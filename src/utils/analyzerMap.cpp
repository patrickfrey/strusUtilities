	...
	const std::string& prgfile)
{
	...
	strus::shared_ptr<strus::DocumentAnalyzerInstanceInterface>
...
const DocumentAnalyzerInstanceInterface* AnalyzerMap::get( const analyzer::DocumentClass& dclass) const
{
